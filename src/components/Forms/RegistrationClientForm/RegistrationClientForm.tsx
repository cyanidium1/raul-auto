      ...
      <DynamicForm initialValues={initialValues} onSubmit={handleSubmit}>
        {(formikProps) => (
          <>
            ...
            <button
              className="bg-gradient-red text-primary text-18 font-bold rounded-sub-block-16 flex items-center justify-center px-[20px] py-[18px] max-w-[678px] w-full h-[60px] transform transition duration-300 ease-in-out hover:scale-105 hover:text-hoverprimary mt-[40px] focus:outline-focus outline-none"
              type="submit"
            >
              Продолжить
            </button>
