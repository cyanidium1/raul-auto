    ...
    <>
      <div className="mobile:pt-8 sm:bg-[url('/hero.png')] mobile:bg-no-repeat mobile:bg-right mobile:bg-contain tablet:bg-right desktop:bg-right desktop:bg-auto mobile:h-[200px] tablet:h-[350px] desktop:h-[800px] desktop:pt-[60px]">
        <div className="max-w-[1696px] mx-auto px-4">
          ...
          <motion.p
            className="mobile:text-center mobile:text-secondary mobile:ml-auto mobile:mr-auto tablet:ml-0 tablet:mr-0 tablet:text-left tablet:max-w-[400px] tablet:text-secondary mobile:text-[20px] tablet:text-[24px] desktop:font-[500] desktop:text-28 desktop:max-w-[610px] desktop:mb-[40px]"
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
