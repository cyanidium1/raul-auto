...
const About = () => {
    ...
    const { adminName, adminTitle, bio, contactPhone, telegramLink, contactLinks } = translations[language];
            ...
            <div className="tablet:flex tablet:space-x-2 mx-auto">
                ...
                <div className="tablet:w-3/5 mobile:mt-3 tablet:mt-0 mobile:mx-auto mobile:rounded-sub-block-10 tablet:rounded-2xl mobile:p-[32px] bg-mapbg">
                    ...
                    <ul className="flex gap-4 mobile:items-center mobile:justify-center">
                        <li>
                            <a className="focus:outline-focus outline-none" href={contactLinks[0]} target='_blank' rel='noreferrer'>
                                <Image
                        ...
                        <li>
                            <a className="focus:outline-focus outline-none" href={contactLinks[1]} target='_blank' rel='noreferrer'>
                                <Image
                                    className='hover:scale-110 duration-300'
                                    src="/massages.png"
                                    alt="icon messenger"
                        ...
                        <li>
                            <a className="focus:outline-focus outline-none" href={contactLinks[2]} target='_blank' rel='noreferrer'>
                                <Image
                                    className='hover:scale-110 duration-300'
                                    src="/WhatsApp.png"
                                    alt="icon whatsapp"
                        ...
                        <li>
                            <a className="focus:outline-focus outline-none" href={contactLinks[3]} target='_blank' rel='noreferrer'>
                                <Image
                                    className='hover:scale-110 duration-300'
                                    src="/viber.png"
                                    alt="icon viber"
