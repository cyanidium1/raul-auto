const FooterCall = () => {
  return (
    <div className="text-white border-[1px] border-white rounded-sub-block-16 py-[20px] px-[37px] tablet:py-[28px] tablet:px-[20px]">
      ...
      <a
        className="w-full max-w-[239px] h-[54px] flex justify-center items-center rounded-sub-block-12 bg-red-600 text-[14px] font-semibold transform transition duration-300 ease-in-out hover:scale-105 animate-pulse"
